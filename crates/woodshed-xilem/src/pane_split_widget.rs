...
// Vendored from masonry's `Split` widget (Apache-2.0/MIT) so woodshed can
// carry the split-bar drag-readback (`SplitDragged`) without forking
// masonry. Adapted: `crate::` → public `masonry::` paths; doc-screenshot
// macro + test module dropped.
...
use masonry::kurbo::{Axis, Join, Line, Point, Size, Stroke};
